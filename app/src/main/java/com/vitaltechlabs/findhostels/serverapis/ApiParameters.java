...
public class ApiParameters
{
	...
	/////
//Rate us Details
	public static Map<String, String> getRateusSuccess(String ptnt_cd, String p_rating, String p_feedBack, String p_deviceId, String p_os_version,
	...
	public static Map<String, String> getNotifications(String ptnt_cd, String p_deviceId,
	                                                   String p_os_type)
	{
		Map<String, String> params = new HashMap<String, String>();
	...
	public static Map<String, String> passGetPaySuccess(String orderno, String payid, String paydt, String amt, String transid, String paymethod, String ipaddress,
	                                                    String paystatus, String payopt)
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("P_ORDERNO", orderno);
	...
	public static Map<String, String> passMyCartDetails(String city, String testCode, String testId,
	                                                    String totalAmt, String grossAmt, String totaldisc,
	                                                    String ofrCode, String productGrossAmt, String disc,
	                                                    String promodisc, String otherCharge1, String otherCharge2,
	                                                    String grandTotal, String roundAmt, String promoCode)
	{
	...
	public static Map<String, String> passPayDetails(String flag, String orderid, String ptntcode, String address,
	                                                 String loc, String city, String state, String country, String zip,
	                                                 String doctor, String colDateFrom, String colDateTo, String hardCopy,
	                                                 String colContact, String test, String ptntName, String createBy,
	                                                 String grossAmt, String discount_flag, String discount, String promocode,
	                                                 String paymode, String paymentOpt, String title, String firstName,
	                                                 String lastName, String dob, String gender, String dobActFlg,
	                                                 String mobileNo, String emailId, String cartId, String coltype,
	                                                 String labid)
	{
	...
	public static Map<String, String> passLabLocations(String city, String landmark, String pincode,
	...
	public static Map<String, String> passGetReports(String ptntcode, String pwd, String deviceid,
	                                                 String deviceToken, String ostype, String osversion,
	                                                 String mysrl_version, String timestamp)
	{
		Map<String, String> params = new HashMap<String, String>();
	...
	public static Map<String, String> getUpdateUserDetails(String commonno, String userId, String password,
	                                                       String mobileNo, String emailid, String address1,
	                                                       String address2, String landmark, String city, String state,
	...
	public static Map<String, String> getMobikwik(String email, String
			amount, String
			                                              cell, String
			                                              orderid, String
			                                              mid, String
	...
	public static Map<String, String> getPdfReports(String city, String acc, String ptntcode, String mobile, String str,
	                                                String deviceid, String deviceToken, String ostype, String osver,
	                                                String mysrlver)
	{
		Map<String, String> params = new HashMap<String, String>();
		params.put("P_CITY", city);
	...
	public static Map<String, String> pendingRegistration(String devid, String devtobepassed)
	{

		Map<String, String> params = new HashMap<String, String>();
		params.put(Constants.deviceID, devid);
		params.put(Constants.devicetobepassed, devtobepassed);
...
//        params.put(Constants.IN_DEVICE_ID, devidtobepassed);
   ...
   /* public static Map<String, String> userRegistration(String salutation, String fname, String lname, String dob, String years,
                                                       ...
                                                       String email, String zip, String deviceid, String ostype, String osversion,
                                                       String mysrlver) {
